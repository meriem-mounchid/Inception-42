...
install:
	...
	-@chmod +x ./srcs/requirements/tools/script.sh
...
build:
	...
	-@$(DC) -f ./srcs/docker-compose.yaml up --build
...
clean:
	...
	-@$(DC) -f ./srcs/docker-compose.yaml down --rmi all -v --remove-orphans 
	-@docker rmi -f debian:buster
	-@sudo rm -rf /home/mmounchi/data/mariadb_data/*
	-@sudo rm -rf /home/mmounchi/data/wordpress_nginx/*
	@echo "$(GREEN)-- Docker-Compose Removed Successfully --$(END)"